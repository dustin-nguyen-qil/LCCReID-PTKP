            ...
            for pdir in pdirs:
                ...
                for img_path in img_dirs:
                    ...
                    if cam == 'A':
                        ...
                        gallery_dataset.append((img_path, pid, camid, 0))
                    elif cam == 'B':
                        clothes_id = pid2label[pid] * 2
                        query_dataset_same_clothes.append((img_path, pid, camid, 0))
                    else:
                        clothes_id = pid2label[pid] * 2 + 1
                        query_dataset_diff_clothes.append((img_path, pid, camid, 0))

        pid2imgidx = {}
        for idx, (img_path, pid, camid, _) in enumerate(gallery_dataset):
